...
//session ko id userid matlab login pachi
            ...
            <div class="review">
              <div class="comment-section">
                ...
                if (isset($_SESSION['user_id'])) {
                  ...
                  //product purchase pachi matra review wala validation
                ...
                <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="
                  ...
                  if (isset($_SESSION['user_id'])) {
                    ...
                    //id - yo bhaneko product category ma url ma get bata ako id
                    if (in_array($id, $pid)) {
