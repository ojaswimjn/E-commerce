...
if (isset($_POST['checkout'])) {
    ...
    //ymd ma why because of paypal - paypal takes yymmdd
    //collectionslot ma no cru
//userorder table ma date cha
    ...
    $_SESSION['checkout_error'] = "Please select a collection slot.";
}
?>
<!DOCTYPE html>
<html lang="en">
