                ...
                <body style="background-color:white;">
                    ...
                    <div class="container d-flex justify-content-center mt-60">
                        <div class="row">
                            <?php
                            $query = "SELECT a.* FROM 
                            (SELECT PRODUCT_ID, PRICE, PRODUCT_NAME, COUNT_SUM / COUNT_TOTAL AS AVERAGE FROM 
                                (SELECT COUNT(*) AS COUNT_TOTAL, P.PRODUCT_ID, PRICE, PRODUCT_NAME, SUM(REVIEW_RATING) AS COUNT_SUM 
                                FROM PRODUCT P 
