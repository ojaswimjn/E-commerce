...
//restriction of trader to use 
if (!empty($_SESSION["user_role"])) {
    if ($_SESSION["user_role"] == "T") {
        header('location: login.php');
        //die function is used here to ensure that the script stops executing after the redirect to login.php
        die;
    }
}
?>
        ...
        <div class="row">
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <!--id:navigate the dropdown menu
                        aria-expanded th dropdown is not expanded by default-->
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <!--category name ni print bhairako cha ani link le tyo afno afno thau ma gairako cha-->
