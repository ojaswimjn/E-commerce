...
<div class="wrapper">
      ...
      <form action="shop.php" method="get">
        <ul class="list-group">
          ...
          ?>
              ...
              <!--array? multiple kura halna milyo if not it will only take  the last one-->
  ...
  <div id="content">
    ...
    <div class="container text-center">
      ...
      //current page retrienved from $_GET array
      if (isset($_GET["page"])) {
        $page = $_GET["page"];
      } else {
        $page = 1;
      ...
      // Calculates the starting point for the SQL query, determining how many records to skip.
      $limit = ($page - 1) * $perpage; //1-1 *12 0 12 24
      $startfrom = $page * $perpage; //1*12      12 24 36
    ...
    <div class="container d-flex justify-content-center mt-60">
      ...
      //select p.*, ROWNUM rnum FROM ( 
        //select * from product where PRODUCT_STATUS ='1'   ) p WHERE ROWNUM <= 24) WHERE rnum > 12 second page
        $count_q = $query . ")p)";
              ...
              <br><br>
                  ...
                  <div class="product-action" style="margin-bottom: 30px;">
                    <div class="product-action-style">
                        <a href="add_to_wishlist.php?id=<?php echo $product_id; ?>&page=shop.php"> 
...
<!--yha bata balla filter without ko suru-->
<!--not understood yet-->
</div>
</div>
<br>
...
<div class="container text-center">
  ...
  for ($i = 1; $i <= $total_pages; $i++) { ?>
    <a href="shop.php?page=<?php echo $i; ?>" class='text-light' style='text-decoration:none;'><button class='btn button my-5 mt-6' <?php if ($page == $i) {
                                                                                                                                    ?> active <?php
                                                                                                                                            } ?>><?php echo $i; ?></button></a>
  <?php
  }
